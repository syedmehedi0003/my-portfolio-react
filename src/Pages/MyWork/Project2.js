...
const Project2 = () => {
    return (
        ...
        <div className='mt-12 mb-8'>
            <h2 class="text-2xl justify-center font-bold mb-5">Gym House </h2>
            <div className='grid grid-rows-1 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                ...
                <div class="card card-compact w-full lg:w-96 px-5 lg:px-0  bg-base-100 shadow-xl">
                    ...
                    <h2 class="card-title  justify-center pb-4">Manage Product</h2>
            ...
            <div className=" px-10">
                ...
                <div className='text-left lg:flex lg:justify-between'>
                    <div>
                        ...
                        <p>1. User must Login Here. <br />
                            2. User can update product quantity and deliver<br />
                            3. User can delete and add product<br />
                            4. User can Login or Signup using Email and password or using Google <br />
                            5. Without Login or SignUp user do not access this features.
                        </p>
                    </div>
